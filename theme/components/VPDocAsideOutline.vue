...
/*
ORIGINAL:
https://github.com/vuejs/vitepress/blob/main/src/client/theme-default/components/VPDocAsideOutline.vue

MODS:
- respect `frontmatter.outlineTitle`
*/
...
<template>
  <div
    ...
    :class="{
      ...
      'is-advanced': Boolean(frontmatter.outlineTitle),
    }"
    ref="container"
    role="navigation"
  >
    <div class="content">
      ...
      <div class="outline-title" role="heading" aria-level="2">
        {{ frontmatter.outlineTitle || resolveTitle(theme) }}
      </div>
