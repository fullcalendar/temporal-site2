...
/*
ORIGINAL:
https://github.com/vuejs/vitepress/blob/main/src/client/theme-default/components/VPNavBarSearchButton.vue

MODS:
- remove all media queries; collapse
- change background and border colors
- justify-content: space-between
*/

import type { ButtonTranslations } from 'vitepress/dist/types/local-search'
